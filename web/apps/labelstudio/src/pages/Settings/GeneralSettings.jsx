...
export const GeneralSettings = () => {
  ...
  const samplings = [
    { value: "Sequential", label: t("Sequential"), description: t("Tasks are ordered by Task ID") },
    { value: "Uniform", label: t("Random"), description: t("Tasks are chosen with uniform random") },
  ];
        ...
        <div className={cn("settings-wrapper").toClassName()}>
          <Form action="updateProject" formData={{ ...project }} params={{ pk: project.id }} onSubmit={updateProject}>
            <Form.Row columnCount={1} rowGap="16px">
              ...
              {isFF(FF_LSDV_E_297) && (
                <div className={cn("workspace-placeholder").toClassName()}>
                  ...
                  <Select placeholder={t("Select an option")} disabled options={[]} />
                  ...
                  <RadioGroup.Button
                    ...
                    label={
                      <>
                        ...
                        <Tooltip title={t("Available on Label Studio Enterprise")}>
                          <Badge
                            variant="enterprise"
                            icon={<IconSpark />}
                            size="small"
                    ...
                    description={
                      <>
                        {t("Tasks are chosen according to model uncertainty score (active learning mode).")}{" "}
                        <a
                          target="_blank"
            ...
            <Form.Actions>
              ...
              <Button type="submit" className="w-[150px]" aria-label={t("Save general settings")}>
                {t("Save")}
              </Button>
            </Form.Actions>
          </Form>
